<?php session_start();
if(isset($_SESSION['loggedin']) && !empty($_SESSION['loggedin']) && ($_SESSION['role'] == 'Patients'))
{
  header("Location:dashboardPatient.php");
}else if(isset($_SESSION['loggedin']) && !empty($_SESSION['loggedin']) && ($_SESSION['email'] == 'superadmin@gmail.com')){
